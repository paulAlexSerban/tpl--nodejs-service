...
docker build --file ../../backend/express-api-server/express-api-server.Dockerfile ../../backend/express-api-server -t $ECR_REPO_NAME:\latest --build-arg NODE_ENV=production
